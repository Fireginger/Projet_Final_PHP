...
{   // debug($_POST);
    ...
    executeRequete("REPLACE INTO article (id, name, description, price, publication_date, author_id, catégorie, image_link) values ('', '$_POST[name]', '$_POST[description]', '$_POST[price]', '$_POST[publication_date]', '$username', '$_POST[catégorie]', '$photo_bdd')");
    $id = $mysqli->insert_id;
...
if(isset($_GET['action']) && ($_GET['action'] == 'ajout' || $_GET['action'] == 'modification'))
{
    if(isset($_GET['id']))
    {
        //faire que article_id soit la meme que id de la table article 
    ...
    <form method="post" enctype="multipart/form-data" action="">
        ...
        <input type="text" id="publication_date" name="publication_date" placeholder="la date de publication du produit" value="'; if(isset($produit_actuel['publication_date'])) echo $produit_actuel['publication_date']; echo '" > <br><br>
